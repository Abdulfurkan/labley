...
// Dynamically import PDFMerger to avoid SSR issues
const PDFMerger = dynamic(
  () => import('../components/pdf-editor/PDFMerger'),
  { ssr: false }
);
...
export default function MergePDFs() {
  ...
  const handleRemoveFile = (indexToRemove) => {
    setPdfFiles(prevFiles => {
      // Revoke the URL of the file being removed
      if (prevFiles[indexToRemove] && prevFiles[indexToRemove].url) {
        URL.revokeObjectURL(prevFiles[indexToRemove].url);
      }
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      <header className="bg-white backdrop-filter backdrop-blur-lg bg-opacity-70 border-b border-gray-100 sticky top-0 z-50 py-4">
        <div className="container mx-auto px-6 flex justify-between items-center">
          ...
          <nav className="hidden md:flex items-center">
            ...
            <div className="relative mx-2">
              <Link href="/merge-pdfs" className="px-4 py-2 font-medium text-blue-600 relative group">
                Merge PDFs
            ...
            {/* Reset Files button removed as requested */}
            <button 
          ...
          {mobileMenuOpen && (
            <div className="md:hidden bg-white shadow-lg rounded-b-lg mt-1 mx-4 overflow-hidden transition-all duration-300 ease-in-out">
              <div className="flex flex-col py-2">
                ...
                {/* Mobile menu Reset Files button removed as requested */}
              </div>
            </div>
          )}
        </div>
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-10 px-4">
          ...
          <div className="max-w-2xl mx-auto relative">
            <p className="text-gray-600 text-lg leading-relaxed mb-6">
              ...
              <span className="hidden sm:inline"> Upload your files, arrange them in your preferred order, and merge them with one click.</span>
            </p>
        ...
        {/* Ad Space between title and upload div */}
        <div className="mb-10">
          <AdSpace type="banner" className="mx-auto" />
        </div>
        ...
        {pdfFiles.length === 0 ? (
          <div className="flex flex-col lg:flex-row justify-between gap-4">
            ...
            <div className="flex-1 min-w-0">
              <PDFUploader onFileSelected={handleFileSelected} pageType="merge" />
            </div>
          ...
          <PDFMerger files={pdfFiles} onReset={handleReset} onRemoveFile={handleRemoveFile} onAddFile={handleFileSelected} />
        )}
      </main>
